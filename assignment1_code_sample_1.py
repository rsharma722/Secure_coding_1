# A03: Injection – fixed SQL and command injection
# A02: Sensitive Data / Crypto – HTTPS, no hardcoded secrets
# A04: Insecure Design – added input validation
# A05: Security Config – least-privilege DB user
